...
function openSubmission(id) {
  ...
  ["months","monthly-hours","discount-type","discount-description"].forEach((id) => document.getElementById(id)?.addEventListener("input", recalc));
