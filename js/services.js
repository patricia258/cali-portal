  ...
  "cali-build": {
    ...
    sections: [
      ...
      { title: "O RH que vai construir", description: "Quero entender quem existe hoje e quem, de fato, vai executar a implantação com a supervisão da CALI.", fields: [
        ...
        { id: "pessoas_rh", label: "Quantas pessoas atuam hoje no RH?", type: "number", min: 0, max: 50, required: true, span: 4 },
        { id: "equipe_rh", label: "Quem faz parte do time de RH hoje?", type: "team_rows", required: true, maxItems: 50, help: "Preencha nome, cargo e senioridade. A quantidade de linhas acompanha o número informado acima; você também pode adicionar ou remover pessoas.", showWhen: { field: "estrutura_rh_status", in: ["em_criacao","pouco_estruturado","parcial","estruturado"] } },
        { id: "responsavel_implantacao", label: "Já existe alguém desse time definido para tocar a implantação entre os checkpoints da CALI?", type: "radio", required: true, options: [option("sim", "Sim, já está definido"), option("definindo", "Está sendo definido"), option("nao", "Ainda não")] },
      ]},
      { title: "O que precisa ser construído", description: "Aqui não repetimos o diagnóstico de maturidade do Mapa. Quero saber qual estrutura precisa sair do papel e qual deve ser o primeiro movimento.", fields: [
        ...
        { id: "frentes", label: "Quais frentes precisam entrar no radar do Build?", type: "checkboxes", required: true, help: "Selecione as frentes que precisam ser construídas ou reorganizadas; a proposta define o que entra primeiro.", showWhen: { field: "escopo_build", in: ["rh_completo","frente_especifica","multiplas_frentes"] }, options: [
          { value: "__all__", label: "Todas as frentes", selectAll: true },
        ...
        { id: "o_que_ja_existe", label: "O que já existe e pode ser aproveitado?", type: "checkboxes", help: "Marque apenas o que já existe hoje. Não precisa detalhar tudo.", options: [
          option("politicas", "Políticas ou normas internas"),
          option("planilhas", "Planilhas ou controles"),
          option("fluxos", "Fluxos ou processos desenhados"),
          option("sistemas", "Sistemas ou ferramentas"),
          option("materiais", "Documentos, modelos ou materiais"),
          option("indicadores", "Indicadores ou dashboards"),
          option("outros", "Outros"),
        ] },
        { id: "o_que_ja_existe_outro", label: "O que mais já existe?", type: "text", maxlength: 500, showWhen: { field: "o_que_ja_existe", includes: "outros" }, placeholder: "Descreva em poucas palavras." },
        { id: "objetivo_primeiro_ciclo", label: "O que seria um bom resultado para o primeiro ciclo?", type: "checkboxes", required: true, help: "Escolha o que mais ajudaria a empresa a perceber avanço real.", options: [
          option("processos", "Processos prioritários definidos e documentados"),
          option("politicas", "Políticas prioritárias prontas ou aprovadas"),
          option("rotinas", "Rotinas e responsabilidades do RH organizadas"),
          option("indicadores", "Indicadores básicos funcionando"),
          option("frente_implantada", "Uma frente prioritária implantada"),
          option("liderancas", "Lideranças orientadas para usar os novos processos"),
          option("roadmap", "Roadmap dos próximos ciclos definido"),
          option("recomendar", "Ainda não sei — quero que a CALI recomende"),
        ] },
      ]},
      { title: "Capacidade de implantação", description: "Só o que interfere de verdade no desenho e no valor: disponibilidade interna e ritmo de acompanhamento.", fields: [
        { id: "capacidade_execucao", label: "Quanto tempo a pessoa responsável consegue dedicar por semana à implantação?", type: "select", required: true, span: 6, options: [option("menos2", "Menos de 2 horas"), option("2a4", "De 2 a 4 horas"), option("5a8", "De 5 a 8 horas"), option("9mais", "9 horas ou mais")] },
        { id: "cadencia_build", label: "Qual ritmo parece viável para os checkpoints com a CALI?", type: "select", required: true, span: 6, options: [option("semanal", "Semanal"), option("quinzenal", "Quinzenal"), option("mensal", "Mensal"), option("recomendar", "Quero que a CALI recomende")] },
      ]},
