...
('cali-build','ESSENCIAL','CALI Build Essencial',4200,1,'{"minimum_months":4,"hours_min":8,"hours_max":12,"price_ceiling":6200,"execution_owner":"client","monthly":true}'::jsonb),
('cali-build','COMPLETO','CALI Build Completo',5600,2,'{"minimum_months":6,"hours_min":14,"hours_max":18,"price_ceiling":7600,"execution_owner":"client","monthly":true}'::jsonb),
