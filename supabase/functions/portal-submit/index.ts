...
const SERVICE_LABELS: Record<string,string> = {
  "assessoria-estrategica":"Assessoria Estratégica Mensal","cali-build":"CALI Build — Estruturação Assistida de RH","mentoria-rh":"Mentoria para Profissionais de RH",
...
function sanitizeAnswer(value:unknown,depth=0):unknown{
  ...
  if(Array.isArray(value))return value.slice(0,50).map((item)=>sanitizeAnswer(item,depth+1));
